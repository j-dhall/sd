package edu.ds.ms.security.restsecurity.config;

import edu.ds.ms.security.restsecurity.filter.JWTAuthenticationFilter;
...
public class RestApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
